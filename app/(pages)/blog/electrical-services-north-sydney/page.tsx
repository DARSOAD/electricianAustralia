...
const SLUG = "electrical-services-north-sydney";
    ...
    return (
        <>
            ...
            <div className="flex flex-col py-8 space-y-2">
                ...
                <Image src={article.cover} alt={article.header} width={1920} height={1080} layout="responsive" className="w-full h-auto"/>
